...
model.fit_generator(train_generator, steps_per_epoch=len(X_train)//64, epochs=30,validation_data=test_generator, validation_steps=len(X_valid)//64)

# save and reload model
model.save('1_5_5_epochs_40_valid_struction_fc512.h5')
...
sub.to_csv('./1_5_5_epochs_40_valid_structure_fc512.csv', index=False)
