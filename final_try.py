...
filepath="./final_try/weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=True, mode='max')
callbacks_list = [checkpoint]
#model = load_model('/home/xuele/project_4950/project_4950/sgd_350epoch_continue/weights-improvement-41-0.99.hdf5')
...
model.save('1_8_8_epochs_350_valid_structure_sgd_ckeck.h5')
...
sub.to_csv('./1_8_8_epochs_350_valid_structure_sgd_check.csv', index=False)
