...
test_generator = test_gen.flow(X_valid, Y_valid, batch_size=256)

filepath="./sgd_350epoch_continue/weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=True, mode='max')
callbacks_list = [checkpoint]
model = load_model('/home/xuele/project_4950/project_4950/sgd_350epoch/weights-improvement-112-0.99.hdf5')
model.fit_generator(train_generator, steps_per_epoch=len(X_train)//256, epochs=350,callbacks=callbacks_list,validation_data=test_generator, validation_steps=len(X_valid)//256)

# save and reload model
model.save('1_7_7_epochs_350_valid_structure_sgd_ckeck.h5')
...
sub.to_csv('./1_7_7_epochs_350_valid_structure_sgd_check.csv', index=False)
