...
gen = ImageDataGenerator(rotation_range=8, width_shift_range=0.04, shear_range=0.3,
                         height_shift_range=0.04, zoom_range=0.04)

#gen = ImageDataGenerator()
test_gen = ImageDataGenerator()
train_generator = gen.flow(X_train, Y_train, batch_size=64)
#test_generator = test_gen.flow(X_valid, Y_valid, batch_size=64)
model.fit_generator(train_generator, steps_per_epoch=len(X_train)//64, epochs=30)

# save and reload model
model.save('1_4_4_aug_512fc_30_1_1.h5')
...
sub.to_csv('./1_4_4_aug_512fc_30_1_1.csv', index=False)
